...
main = do
    ...
    let files = fmap (\x -> "/home/lesserfish/Documents/Code/Shrimp/exe/Test/TomHarte/6502/v1/" ++ showPaddedHex x ++ ".json") opcodes
    testFiles files
...
addBCD :: Word8 -> Word8 -> Word8
addBCD l r = result
  where
    l' = encodeBCD l
    r' = encodeBCD r
    sum = l' + r'
    result = decodeBCD sum
