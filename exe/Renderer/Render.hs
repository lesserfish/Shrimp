...
renderCPU = do
    ...
    liftIO $ updatePatternTexture ctx nes (rtPattern rctx)
...
render = do
    ...
    when (rRDisplayMode rctx == DM_PATTERN_1) (SDL.copy renderer (rtPattern rctx) (windowSegment (0, 0) (128, 128)) (windowSegment (600, 300) (300, 300)))
    when (rRDisplayMode rctx == DM_PATTERN_2) (SDL.copy renderer (rtPattern rctx) (windowSegment (0, 128)   (128, 128)) (windowSegment (600, 300) (300, 300)))
